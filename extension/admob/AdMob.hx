...
class AdMob {
	...
	private static var __init:String->String->String->String->Bool->Dynamic->Void = function(bannerId:String, interstitialId:String, rewardedId:String, gravityMode:String, testingAds:Bool, callback:Dynamic){};
	...
	public static function initAndroid(bannerId:String, interstitialId:String, rewardedId:String, gravityMode:GravityMode){
		#if android
		if(initialized) return;
		initialized = true;
		try{
			// JNI METHOD LINKING
			__init = openfl.utils.JNI.createStaticMethod("admobex/AdMobEx", "init", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLorg/haxe/lime/HaxeObject;)V");
			...
			__init(bannerId,interstitialId, rewardedId, (gravityMode==GravityMode.TOP)?'TOP':'BOTTOM',testingAds, getInstance());
		}catch(e:Dynamic){
	...
	public static function showRewardedAd()
	{
		try {
			__showRewarded();
		} catch(e:Dynamic) {
